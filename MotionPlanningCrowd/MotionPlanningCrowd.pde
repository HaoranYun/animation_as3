...
void setupCompareInteractionMode(){
  ...
  // Scenario 1
  for(int i = 0; i< 4; i++){
    obstacles.add(new Obstacle(obstacle_radius, 400, 100 + 100 *i, 0.0));
  }
    
  for(int i = 0; i< 4; i++){
    obstacles.add(new Obstacle(obstacle_radius, 250, 200 + 100 *i, 0.0));
  }
...
void setupCommonMode(){
  ...
  //}
    ...
    for(int i = 0; i< 4; i++){
      obstacles.add(new Obstacle(obstacle_radius, 200, 200 + 100 *i, 0.0));
    }
...
void  setupCompareNavigationMode(){
  ...
  for(int i = 0; i< 1; i++){
    obstacles.add(new Obstacle(obstacle_radius, 520, 400, 0.0));
  }
...
void draw() {
  ...
  for(int i = 0; i< obstacles.size(); i ++){
    ...
    //popMatrix();
    drawCylinder(int(obstacles.get(i).center.x), int(obstacles.get(i).center.y), int(obstacles.get(i).center.z), 60, obstacles.get(i).r, 80);
...
void drawCylinder(int center_x, int center_y, int center_z, int sides, float r, int h)
{
...
void mousePressed(){
  obstacles.add(new Obstacle(obstacle_radius, mouseX, mouseY,0.0));
  sampleSomePoints();
}
