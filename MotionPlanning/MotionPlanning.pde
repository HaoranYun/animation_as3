...
PVector movingGoal = new PVector(600,100);
...
void setup() {
  ...
  for(int i = 0; i< 4; i++){
    obstacles.add(new Obstacle(100, 400, 100 + 100 *i));
  }
  
 for(int i = 0; i< 1; i++){
    obstacles.add(new Obstacle(100, 520, 400));
  }
  ...
  for(int i = 0; i < 20; i ++){
    agents.add(new Agent(new PVector(80 + 20*(i%5), 300 + 20* ((int)i/5 ))));
    //agents2.add(new Agent2(new PVector(80 + 15*(i%5), 300 + 15* ((int)i/5 ))));
    //agents2.get(i).runBFS = true;
  }
  
 for(int i = 0; i < 20; i ++){
    agents.add(new Agent(new PVector(400 + 20*((int)i/5), 500 + 20* ((int)i%5 ))));
    //agents2.add(new Agent2(new PVector(80 + 15*(i%5), 300 + 15* ((int)i/5 ))));
    //agents2.get(i).runBFS = true;
  }
  ...
  for(int i = 0; i < agents.size(); i++){
    ...
    { 
      ...
      agents.get(i).searchPath(agents.get(i).pos,new PVector(600,100));
 ...
 // for(int i = 0; i < agents.size(); i ++){
 //   agents.get(i).searchPath(agents.get(i).pos,new PVector(600,100)); 
 //   //agents2.get(i).searchPath(agents.get(i).pos,new PVector(600,100));
 // }
 //}
  //println((millis()-s)/300);
...
void draw() {
  ...
  for(int i = 0; i< obstacles.size(); i ++){
    fill(0,0,255);
    circle(obstacles.get(i).center.x,obstacles.get(i).center.y, obstacles.get(i).r);
    //fill(0,255,0,100);
    //circle(obstacles.get(i).center.x,obstacles.get(i).center.y, 115);
